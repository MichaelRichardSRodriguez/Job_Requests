...
namespace Job_Requests.DataAccess.Repositories
{
	public class Repository<T> : IRepository<T> where T : class
	{
		...
		public async Task<IEnumerable<T>> GetPaginatedAsync(int page, int pageSize, Expression<Func<T, bool>>? filter = null, bool tracked = false, params string[]? includeProperties)
		{
			IQueryable<T> query = tracked ? _dbSet : _dbSet.AsNoTracking();
